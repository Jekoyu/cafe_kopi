        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="name" class="form-control"
                   value="{{ old('name') }}" placeholder="Contoh: Kopi 1815" required>
          </div>

          <div class="col-md-6">
            <label class="form-label fw-semibold">Harga</label>
            <input type="text" name="price" class="form-control"
                   value="{{ old('price') }}" placeholder="Contoh: 23k / 30k" required>
            <div class="form-text">Boleh format multi-size: <code>20k / 27k / 30k</code></div>
          </div>
